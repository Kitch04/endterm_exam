...
<head>
    ...
    <link rel="css" href="css">
 </head>
<body style="background-color: lightblue;">
        <div class="welcome">
            <h1>Endterm Portfolio</h1>
        </div>    
        <div>
            <ul class="nav-area">
        ...
        <div>
            <img class="astro" src="../img/Astronaut/Astronaut-01.svg" width="200px">
        </div>
        <div class="moon">
            <img src="../img/full_moon.svg" width="500px">
            </div>
    <div class="learning">
        <ul>
            <li><h1>LEARNING TASK 2.2</h1></li>
            <li><a href="https://codepen.io/KitchPua/pen/ZEWvBNP">Rotate</a></li>
            <li><a href="https://codepen.io/KitchPua/pen/PoNEbMO">Scale</a></li>
            <li><a href="https://codepen.io/KitchPua/pen/jOqYyOe">Skew</a></li>
            <li><a href="https://codepen.io/KitchPua/pen/ExKoZaa">Translate</a></li>
        </ul>
        <ul>
        ...
        <ul>
            ...
            <li><a href="https://codepen.io/KitchPua/pen/wvGQJXz">Logo Animation</a></li>
            <li><a href="https://codepen.io/KitchPua/pen/bGpQqjB">Text Animation</a></li>
        </ul>
        <ul>
            <li><h1>LEARNING TASK 4.1</h1></li>
            <li><a href="https://codepen.io/KitchPua/pen/wvGQJXz">Logo Animation</a></li>
            <li><a href="https://codepen.io/KitchPua/pen/bGpQqjB">Text Animation</a></li>
        </ul>
        <ul>
